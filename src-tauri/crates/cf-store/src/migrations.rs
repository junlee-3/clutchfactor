...
const MIGRATIONS: &[(i64, &str)] = &[
    ...
    (3, include_str!("../migrations/0003_flag_evidence.sql")),
    (4, include_str!("../migrations/0004_match_kind.sql")),
    (5, include_str!("../migrations/0005_corpus_grids.sql")),
    (6, include_str!("../migrations/0006_round_review.sql")),
    (
        7,
        include_str!("../migrations/0007_round_review_fingerprint.sql"),
    ),
    (8, include_str!("../migrations/0008_round_plays.sql")),
    (9, include_str!("../migrations/0009_coach_cache.sql")),
    (10, include_str!("../migrations/0010_stats.sql")),
    (11, include_str!("../migrations/0011_map_callouts_z.sql")),
];
